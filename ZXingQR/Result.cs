...
namespace com.google.zxing
{
	...
	public sealed class Result
	{
		...
		/// like orientation.
		/// </returns>
		public Dictionary<object, object> ResultMetadata
		{
			get
			{
		...
		private Dictionary<object, object> resultMetadata;
		
		public Result(String text, sbyte[] rawBytes, ResultPoint[] resultPoints, BarcodeFormat format)
		{
			if (text == null && rawBytes == null)
			{
				throw new Exception("ArgumentException: Text and bytes are null");
			}
			this.text = text;
		...
		public void  putMetadata(ResultMetadataType type, Object value_Renamed)
		{
			...
			{
				resultMetadata = new Dictionary<object, object>();
			}
