...
namespace com.google.zxing.datamatrix.detector
{
	...
	public sealed class Detector
	{
		...
		private static readonly Int32[] INTEGERS = new Int32[]{0, 1, 2, 3, 4};
		...
		public DetectorResult detect()
		{
			...
			Dictionary<object, object> pointCount = new Dictionary<object, object>();
			...
			IEnumerator<object> points = pointCount.Keys.GetEnumerator();
			...
			while (points.MoveNext())
			{
				...
				Int32 value_Renamed = (Int32) pointCount[point];
				if (value_Renamed == 2)
				{
		...
		private static void  increment(Dictionary<object, object> table, ResultPoint key)
		{
            ...
            // Added
            // START
            Int32 value_Renamed = 0;
            try
            {
                if (table.Count > 0)
                    value_Renamed = (Int32)table[key];
            }
            catch
            {
                value_Renamed = 0;
		...
		private static BitMatrix sampleGrid(BitMatrix image, ResultPoint topLeft, ResultPoint bottomLeft, ResultPoint bottomRight, int dimension)
		{
			...
			return sampler.sampleGrid1(image, dimension, 0.0f, 0.0f, dimension, 0.0f, dimension, dimension, 0.0f, dimension, topLeft.X, topLeft.Y, topRightX, topRightY, bottomRight.X, bottomRight.Y, bottomLeft.X, bottomLeft.Y);
		}
	...
	internal class ResultPointsAndTransitions
	{
	...
	internal class ResultPointsAndTransitionsComparator : Comparator
	{
