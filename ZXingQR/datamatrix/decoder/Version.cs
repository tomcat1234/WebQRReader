...
namespace com.google.zxing.datamatrix.decoder
{
	...
	public sealed class Version
	{
		...
		{
			return new Version[]{new Version(1, 10, 10, 8, 8, ECBlocks.CreateECBlocks1(5, new ECB(1, 3))), new Version(2, 12, 12, 10, 10, ECBlocks.CreateECBlocks1(7, new ECB(1, 5))), new Version(3, 14, 14, 12, 12, ECBlocks.CreateECBlocks1(10, new ECB(1, 8))), new Version(4, 16, 16, 14, 14, ECBlocks.CreateECBlocks1(12, new ECB(1, 12))), new Version(5, 18, 18, 16, 16, ECBlocks.CreateECBlocks1(14, new ECB(1, 18))), new Version(6, 20, 20, 18, 18, ECBlocks.CreateECBlocks1(18, new ECB(1, 22))), new Version(7, 22, 22, 20, 20, ECBlocks.CreateECBlocks1(20, new ECB(1, 30))), new Version(8, 24, 24, 22, 22, ECBlocks.CreateECBlocks1(24, new ECB(1, 36))), new Version(9, 26, 26, 24, 24, ECBlocks.CreateECBlocks1(28, new ECB(1, 44))), new Version(10, 32, 32, 14, 14, ECBlocks.CreateECBlocks1(36, new ECB(1, 62))), new Version(11, 36, 36, 16, 16, ECBlocks.CreateECBlocks1(42, new ECB(1, 86))), new Version(12, 40, 40, 18, 18, ECBlocks.CreateECBlocks1(48, new ECB(1, 114))), new Version(13, 44, 44, 20, 20, ECBlocks.CreateECBlocks1(56, new ECB(1, 144))), new Version(14, 48, 48, 22, 22, ECBlocks.CreateECBlocks1(68, new ECB(1, 174))), new Version(15, 52, 52, 24, 24, ECBlocks.CreateECBlocks1(42, new ECB(2, 102))), new Version(16, 64, 64, 14, 14, ECBlocks.CreateECBlocks1(56, new ECB(2, 140))), new Version(17, 72, 72, 16, 16, ECBlocks.CreateECBlocks1(36, new ECB(4, 92))), new Version(18, 80, 80, 18, 18, ECBlocks.CreateECBlocks1(48, new ECB(4, 114))), new Version(19, 88, 88, 20, 20, ECBlocks.CreateECBlocks1(56, new ECB(4, 144))), new Version(20, 96, 96, 22, 22, ECBlocks.CreateECBlocks1(68, new ECB(4, 174))), new Version(21, 104, 104, 24, 24, ECBlocks.CreateECBlocks1(56, new ECB(6, 136))), new Version(22, 120, 120, 18, 18, ECBlocks.CreateECBlocks1(68, new ECB(6, 175))), new Version(23, 132, 132, 20, 20, ECBlocks.CreateECBlocks1(62, new ECB(8, 163))), new Version(24, 144, 144, 22, 22, ECBlocks.CreateECBlocks2(62, new ECB(8, 156), new ECB(2, 155))), new Version(25, 8, 18, 6, 16, ECBlocks.CreateECBlocks1(7, new ECB(1, 5))), new Version(26, 8, 32, 6, 14, ECBlocks.CreateECBlocks1(11, new ECB(1, 10))), new Version(27, 12, 26, 10, 24, ECBlocks.CreateECBlocks1(14, new ECB(1, 16))), new Version(28, 12, 36, 10, 16, ECBlocks.CreateECBlocks1(18, new ECB(1, 22))), new Version(29, 16, 36, 10, 16, ECBlocks.CreateECBlocks1(24, new ECB(1, 32))), new Version(30, 16, 48, 14, 22, ECBlocks.CreateECBlocks1(28, 
				new ECB(1, 49)))};
		}
	}
