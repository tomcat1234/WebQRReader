...
public class SupportClass
{
	...
	public static byte[] ToByteArray1(sbyte[] sbyteArray)
	{
		byte[] byteArray = null;
	...
	/// <returns>The new array of bytes</returns>
	public static byte[] ToByteArray2(String sourceString)
	{
	...
	public static byte[] ToByteArray3(Object[] tempObjectArray)
	{
		byte[] byteArray = null;
	...
	public static int URShift1(int number, int bits)
	{
		if ( number >= 0)
			return number >> bits;
		else
	...
	/// <param name="bits">Ammount of bits to shift</param>
	/// <returns>The resulting number from the shift operation</returns>
	public static int URShift2(int number, long bits)
	{
		return URShift1(number, (int)bits);
	}
	...
	/// <param name="bits">Ammount of bits to shift</param>
	/// <returns>The resulting number from the shift operation</returns>
	public static long URShift3(long number, int bits)
	{
		if ( number >= 0)
			return number >> bits;
		else
	...
	/// <param name="bits">Ammount of bits to shift</param>
	/// <returns>The resulting number from the shift operation</returns>
	public static long URShift4(long number, long bits)
	{
		return URShift3(number, (int)bits);
	}
	...
	public static long Identity1(long literal)
	{
		return literal;
	}
	...
	/// <param name="literal">The literal to return</param>
	/// <returns>The received value</returns>
	public static ulong Identity2(ulong literal)
	{
		return literal;
	}
	...
	/// <param name="literal">The literal to return</param>
	/// <returns>The received value</returns>
	public static float Identity3(float literal)
	{
		return literal;
	}
	...
	/// <param name="literal">The literal to return</param>
	/// <returns>The received value</returns>
	public static double Identity4(double literal)
	{
		return literal;
	}
