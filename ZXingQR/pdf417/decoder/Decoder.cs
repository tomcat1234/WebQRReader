...
namespace com.google.zxing.pdf417.decoder
{
	...
	public sealed class Decoder
	{
		...
		public DecoderResult decode1(bool[][] image)
		{
		...
		/// </returns>
		/// <throws>  ReaderException if the PDF417 Code cannot be decoded </throws>
		public DecoderResult decode2(BitMatrix bits)
		{
		...
		{
			if ((erasures != null && erasures.Length > Math.Floor(numECCodewords / 2) + MAX_ERRORS) || (numECCodewords < 0 || numECCodewords > MAX_EC_CODEWORDS))
			{
