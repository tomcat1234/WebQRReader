...
namespace com.google.zxing
{
	...
	public sealed class MultiFormatReader : Reader
	{
		...
		/// </param>
		public Dictionary<object, object> Hints
		{
			get { throw new Exception("NotImplementedException"); }
			set
			{
				this.hints = value;
		...
		private Dictionary<object, object> hints;
		...
		private Result decodeInternal(BinaryBitmap image)
		{
			...
			for (int i = 0; i < size; i++)
			{
				...
				try
				{
					return reader.decode2(image, hints);
				}
				catch (Exception e)
				{
