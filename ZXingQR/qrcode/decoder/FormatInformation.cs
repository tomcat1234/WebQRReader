...
namespace com.google.zxing.qrcode.decoder
{
	...
	sealed class FormatInformation
	{
		...
		internal static int numBitsDiffering(int a, int b)
		{
			...
			return BITS_SET_IN_HALF_BYTE[a & 0x0F] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 4) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 8) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 12) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 16) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 20) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 24) & 0x0F)] + BITS_SET_IN_HALF_BYTE[(SupportClass.URShift1(a, 28) & 0x0F)];
		}
