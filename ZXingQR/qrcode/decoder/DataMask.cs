...
namespace com.google.zxing.qrcode.decoder
{
	...
	internal class DataMask000 : DataMask
	{
	...
	internal class DataMask001 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			return (i & 0x01) == 0;
	...
	internal class DataMask010 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			return j % 3 == 0;
	...
	internal class DataMask011 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			return (i + j) % 3 == 0;
	...
	internal class DataMask100 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			return (((SupportClass.URShift1(i, 1)) + Math.Floor(j / 3)) & 0x01) == 0;
		}
	}

	/// <summary> 101: mask bits for which xy mod 2 + xy mod 3 == 0</summary>
	internal class DataMask101 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			int temp = i * j;
	...
	internal class DataMask110 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
			int temp = i * j;
	...
	internal class DataMask111 : DataMask
	{
		internal override bool isMasked(int i, int j)
		{
