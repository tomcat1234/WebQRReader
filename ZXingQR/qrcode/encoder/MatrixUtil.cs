...
namespace com.google.zxing.qrcode.encoder
{
	...
	public sealed class MatrixUtil
	{
		...
		public static void  embedDataBits(BitVector dataBits, int maskPattern, ByteMatrix matrix)
		{
			...
			if (bitIndex != dataBits.size())
			{
				throw new Exception("WriterException: Not all bits consumed: " + bitIndex + '/' + dataBits.size());
			}
		}
		...
		public static void  makeTypeInfoBits(ErrorCorrectionLevel ecLevel, int maskPattern, BitVector bits)
		{
			...
			{
				throw new Exception("WriterException: Invalid mask pattern");
			}
			...
			{
				// Just in case.
				throw new Exception("WriterException: should not happen but we got: " + bits.size());
			}
		}
		...
		private static void  embedHorizontalSeparationPattern(int xStart, int yStart, ByteMatrix matrix)
		{
			...
			{
				throw new Exception("WriterException: Bad horizontal separation pattern");
			}
			for (int x = 0; x < 8; ++x)
			{
		...
		private static void  embedVerticalSeparationPattern(int xStart, int yStart, ByteMatrix matrix)
		{
			...
			{
				throw new Exception("WriterException: Bad vertical separation pattern");
			}
			for (int y = 0; y < 7; ++y)
			{
		...
		private static void  embedPositionAdjustmentPattern(int xStart, int yStart, ByteMatrix matrix)
		{
			...
			{
				throw new Exception("WriterException: Bad position adjustment");
			}
			for (int y = 0; y < 5; ++y)
			{
				for (int x = 0; x < 5; ++x)
		...
		private static void  embedPositionDetectionPattern(int xStart, int yStart, ByteMatrix matrix)
		{
			...
			{
				throw new Exception("WriterException: Bad position detection pattern");
			}
			for (int y = 0; y < 7; ++y)
			{
				for (int x = 0; x < 7; ++x)
