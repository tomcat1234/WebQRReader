...
namespace com.google.zxing.qrcode.encoder
{
	...
	public sealed class BitVector
	{
		...
		public int at(int index)
		{
			...
			{
				throw new Exception("ArgumentException: Bad index: " + index);
			}
		...
		public void  appendBit(int bit)
		{
			if (!(bit == 0 || bit == 1))
			{
				throw new Exception("ArgumentException: Bad bit");
			}
		...
		public void  appendBits(int value_Renamed, int numBits)
		{
			...
			{
				throw new Exception("ArgumentException: Num bits must be between 0 and 32");
			}
		...
		public void  xor(BitVector other)
		{
			...
			{
				throw new Exception("ArgumentException: BitVector sizes don't match");
			}
		...
		public override String ToString()
		{
			...
			for (int i = 0; i < sizeInBits; ++i)
			{
				...
				{
					throw new Exception("ArgumentException: Byte isn't 0 or 1");
				}
			}
		...
		private void  appendByte(int value_Renamed)
		{
			if ((sizeInBits >> 3) == array.Length)
			{
				...
				ArrayExtend.Copy(array, 0, newArray, 0, array.Length);
				array = newArray;
			}
