...
namespace com.google.zxing.qrcode.encoder
{
	...
	public sealed class MaskUtil
	{
		...
		public static bool getDataMaskBit(int maskPattern, int x, int y)
		{
			...
			{
				throw new Exception("ArgumentException: Invalid mask pattern");
			}
			...
			switch (maskPattern)
			{
				...
				case 4: 
					intermediate = ((SupportClass.URShift1(y, 1)) + Math.Floor(x / 3)) & 0x1;
					break;
				...
				default: 
					throw new Exception("ArgumentException: Invalid mask pattern: " + maskPattern);
