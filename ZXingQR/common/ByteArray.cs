...
namespace com.google.zxing.common
{
	...
	public sealed class ByteArray
	{
		...
		public void  set_Renamed1(int index, int value_Renamed)
		{
		...
		public void  reserve(int capacity)
		{
			if (bytes == null || bytes.Length < capacity)
			{
				...
				if (bytes != null)
				{
					ArrayExtend.Copy(bytes, 0, newArray, 0, bytes.Length);
				}
				bytes = newArray;
			}
		}
		...
		public void  set_Renamed2(sbyte[] source, int offset, int count)
		{
