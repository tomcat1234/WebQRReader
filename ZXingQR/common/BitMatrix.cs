	...
	public sealed class BitMatrix
	{
		...
		public int Dimension
		{
			get
			{
				if (width != height)
				{
					throw new Exception("SystemExpection: Can't call getDimension() on a non-square matrix");
				}
				return width;
			}
		...
		public static BitMatrix CreateSquareInstance(int dimension)
		{
		...
		public bool get_Renamed(int x, int y)
		{
			...
			return ((SupportClass.URShift1(bits[offset], (x & 0x1f))) & 1) != 0;
		}
